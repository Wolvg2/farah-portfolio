...
function About() {
    return (
        <div className="min-h-screen w-full flex flex-col justify-between px-4 md:px-10 py-10">
            <div className="max-w-[92%] w-full mx-auto bg-[url('/Assets/paper-texture.jpg')] bg-repeat bg-[#e8e8e8] bg-blend-multiply shadow-2xl p-6 md:p-18 lg:p-20 ">
                {/* Tu contenido aquí */}
                ...
                <div className="flex grid-cols-2 gap-4">
                    <img
                        src="/Assets/yo.png"
                        className="w-28 h-28 md:w-36 md:h-36 lg:w-100 lg:h-100 mb-9"
                        alt="Decoración luna/estrellas"
                    />
                    <div className="font-custom text-lg md:text-xl lg:text-4xl text-[#2f1d1a] leading-relaxed">
